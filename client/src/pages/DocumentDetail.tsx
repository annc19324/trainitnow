...
export default function DocumentDetailPage() {
  ...
  const handleDownload = async (e: React.MouseEvent, format: "docx" | "pdf") => {
    ...
    if (format === "pdf" && !doc.fileUrl.toLowerCase().endsWith(".pdf")) {
      // Convert the HTML description dynamically into a gorgeous styled PDF!
      // Create a temporary styled container to hold the content
      ...
      container.style.background = "#ffffff"; // elegant white for crisp printing
      container.style.color = "#0f172a";
      container.style.fontFamily = "'Montserrat', sans-serif";
      container.style.lineHeight = "1.7";
      container.style.boxSizing = "border-box";

      // Add a professional document header
      container.innerHTML = `
      ...
      try {
        const canvas = await html2canvas(container, {
          scale: 2, // high-fidelity, high-DPI retina rendering
          useCORS: true,
          logging: false,
